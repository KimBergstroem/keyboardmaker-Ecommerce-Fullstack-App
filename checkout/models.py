...
class Order(models.Model):
    ...
    def _generate_order_number(self):
        """
        Generate a random, unique order number using UUID - Protected with _ prefix
        """
    ...
    def save(self, *args, **kwargs):
        """
        Override the orginial save method to set the order number
...
class OrderLineItem(models.Model):
    ...
    def save(self, *args, **kwargs):
        """
        Override the orginial save method to set the lineitem total
