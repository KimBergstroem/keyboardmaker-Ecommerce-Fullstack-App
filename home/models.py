...
class SubscribedUsers(models.Model):
    ...
    def send_thank_you_email(self):
        ...
        message = render_to_string('home/email_templates/thank_you_email.html', {'user': self})
    ...
    def unsubscribe(self):
        try:
            ...
            subscriber = SubscribedUsers.objects.get(email=self.email, subscribed=True)
            # Set subscribed to False and save
            subscriber.subscribed = False
            subscriber.save()
            # Delete the instance
            subscriber.delete()
            return True  # Indicate successful unsubscribe
