...
ALLOWED_HOSTS = ['8000-kimbergstroem-pp5-7080wnht9mo.ws-eu107.gitpod.io', 'localhost']
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'django.template.context_processors.request', # by allauth
...
if 'USE_AWS' in os.environ:
    ...
    # AWS Bucket Config
    AWS_STORAGE_BUCKET_NAME = 'easykeyboardmaker'
